...
// baseUrl to the remote host that served this file. Otherwise requirejs up on
// the file: protocol and combines it with baseUrl in amd-config create a
// baseUrl of file:///bower_components.
...
define('scripts/main', function(require) {
  'use strict';
  require('components/reportgrouphistogram/reportgrouphistogram');
});
